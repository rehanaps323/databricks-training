...
if temperature > 60 and sunny:
    print("It's hot and sunny today! lets get ice cream")
elif temperature >= 60 and not sunny:
    print("It's not so hot today! lets get a dumplings")
elif temperature < 60 :
    print("It's cold today. lets stay inside and have hot tea")
...
if km_since_last_change >= 15000 and oil_change_light:
    ...
    print("Waiting")
elif km_since_last_change < 15000:
    print("No oil change is required")
