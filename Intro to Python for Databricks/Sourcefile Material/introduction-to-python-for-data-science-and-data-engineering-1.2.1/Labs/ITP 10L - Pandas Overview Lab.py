...
import pandas as pd
columns = ["Name", "Age", "Breed"]
mydata = [["Buddy", 3, "Australian Shepherd"], ["Harley", 10, "Labrador"], ["Luna", 2, "Golden Retriever"], ["Bailey", 8, "Chihuahua"]]
...
df = pd.DataFrame(data=mydata, columns=column_names )
